...
- [ ] Add progress rail showing all generation stages (Head → Full Body → Side → Walk → Back)
- [ ] Implement floating tool palette on image hover
- [ ] Add quick actions bar (Download, Export, Share, Iterate)
- [ ] Make Director's Note panel collapsible with smooth animation
- [ ] Add ambient lighting effects based on generated image colors
- [ ] Add subtle vignette overlay option for cinematic feel


## Workspace UI Enhancements (Completed)
- [x] Add progress rail showing all generation stages at top of workspace
- [x] Implement floating tool palette that appears on hover
- [x] Add quick actions bar (upscale placeholder, export)
- [x] Make Director's Note panel collapsible with smooth animation
- [x] Add ambient lighting effects based on dominant image colors
- [ ] Add cinematic vignette/film-grain overlay options (future)
