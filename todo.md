...
- [x] Bug: Sidebar highlight bleeds — fixed: inline styles for active/disabled/glowing (React-controlled), CSS-only for hover, narrowed transition-all to transition-colors
