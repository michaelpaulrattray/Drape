...
- [x] Remove pre-generation splash screen (CASTING STUDIO title screen)
- [x] Show post-generation workspace layout from the start
- [x] Add empty/placeholder state for main image area before first generation
- [x] Keep left sidebar thumbnails visible but in locked/empty state
- [x] Show "Generate First Model" CTA in the empty image area
- [x] Maintain Director's Note section in empty state
