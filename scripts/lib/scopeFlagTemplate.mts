...
export const HAND_SITES: ReadonlyArray<{ where: string; what: string }> = [
  ...
  { where: "docs/architecture/FEATURE_FLAGS.md", what: "the flag's ENTRY — what is inert without it, what it costs, and its parent; this is where the law lives since #330 carved the catalogue out of CLAUDE.md" },
  { where: "CLAUDE.md", what: "one LOCATOR row in the flag index table — the name and which road it governs, and nothing else; a rule written here becomes a second law that drifts from the entry" },
