...
export const ROADS: readonly Road[] = [
  {
    ...
    doors: ["roll.likeness", "roll.not_a_being", "roll.reader_outage", "roll.uninterpretable", "roll.unsupported_cohort"],
    doorsNote:
      "THE ROLL ENTRANCE'S FIVE WALLS ARE ON THE MAP AS OF #206 — declared from `ROLL_REFUSAL_COPY`, entrance-qualified `roll.*`, "
      ...
      + "would be free at all five. The SIGN entrance is still outside the declared set entirely (fable-1357 §2).",
    flags: ["CASTING_V2_SCOPE", "CASTING_RETRY_SCOPE"],
    notes: [
