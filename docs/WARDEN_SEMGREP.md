...
| 2026-09-19 | 1.174.0 | 76 | 1831 | 0 | Warden patrol #4, read at the gate's own `static-shapes` job (run 35428421774, PR #1046, `9dfe8c2b`) — semgrep has been its own required check since #1040. Targets 1850 (run 3, 13 Sep) → 1831: the janitor's #108 slices removed unused client primitives, not readers. Runs 2 and 3 recorded their semgrep readings in `WARDEN_LOG.md` only; from this run the seat appends here too, as this table's heading says it does. |
