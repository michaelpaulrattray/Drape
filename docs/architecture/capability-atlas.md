...
| `unreadable` | interpreter-refusal |  | server/castingV2/castingIntent.ts:1253<br>server/castingV2/castingIntent.ts:1283<br>(+14) | 17 test(s) | light.softer, guard.gibberish, guard.scope.ink.none |
