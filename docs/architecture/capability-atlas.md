...
| door | kind | charge | where it lives | pinned | reached by |
|---|---|---|---|---|---|
| `candidate_missing` | service-refusal |  | server/castingV2/refineService.ts:1217 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `already_signed` | service-refusal |  | server/castingV2/refineService.ts:1234 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `busy` | service-refusal |  | server/castingV2/refineService.ts:4886<br>server/castingV2/rollEngine.ts:122<br>(+1) | 2 test(s) | _documented-unreachable or gap — see findings_ |
| `refine_limit` | service-refusal |  | server/castingV2/refineService.ts:4345 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `master_missing` | service-refusal |  | server/castingV2/refineService.ts:1223 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `version_missing` | service-refusal |  | server/castingV2/refineService.ts:2554 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `history_unreadable` | service-refusal |  | server/castingV2/refineService.ts:3651 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `history_predates_undo` | service-refusal |  | server/castingV2/refineService.ts:2948 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `step_moved` | service-refusal |  | server/castingV2/refineService.ts:2628 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `kind_unserved` | service-refusal |  | server/castingV2/refineService.ts:2682 | 1 test(s) | _documented-unreachable or gap — see findings_ |
...
| `scope_unknown` | service-refusal |  | server/castingV2/refineService.ts:1304<br>server/castingV2/refineService.ts:1342 | 2 test(s) | guard.scope.unknown |
| `scope_mismatch` | service-refusal |  | server/castingV2/refineService.ts:4865 | 1 test(s) | _documented-unreachable or gap — see findings_ |
...
| `removal_absent` | service-refusal |  | server/castingV2/refineService.ts:3419 | 1 test(s) | ink.remove.none, skin.freckles.remove.none |
| `removal_unnamed` | service-refusal |  | server/castingV2/refineService.ts:2991 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `removal_not_in_brief` | service-refusal |  | server/castingV2/refineService.ts:3400 | 1 test(s) | acc.glasses.remove.none, acc.remove.branch.other |
| `removal_uncheckable` | service-refusal |  | server/castingV2/refineService.ts:3177<br>server/castingV2/refineService.ts:3194 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `removal_reread_unmatched` | service-refusal |  | server/castingV2/refineService.ts:3495 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `removal_unnameable` | service-refusal |  | server/castingV2/refineService.ts:4315 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `already_original` | service-refusal |  | server/castingV2/refineService.ts:2582 | 1 test(s) | guard.undo |
...
| concept.unreadable | concept-refusal |  | cohortWallRetry.test.ts, conceptDescribe.test.ts, conceptDescribeCopy.test.ts, creativeRegisterScope.test.ts, hairColourFromReference.test.ts, hairReferenceCutter.test.ts, inkReferenceCutter.test.ts, inkUploadDoor.test.ts, makeupFromReference.test.ts, openLaneAccept.test.ts, openLaneKind.test.ts, readerOutageRefusal.test.ts, referenceAttachService.test.ts, referenceClassGate.test.ts, referenceMediumDoor.test.ts, referenceWordsLane.test.ts, refineInterpreterCeiling.test.ts, refineService.test.ts, truncatedReplyReaders.test.ts, uploadRefusalCopy.test.ts, server/db/referenceReadDemand.test.ts |
...
| unreadable | interpreter-refusal |  | cohortWallRetry.test.ts, conceptDescribe.test.ts, conceptDescribeCopy.test.ts, creativeRegisterScope.test.ts, hairColourFromReference.test.ts, hairReferenceCutter.test.ts, inkReferenceCutter.test.ts, inkUploadDoor.test.ts, makeupFromReference.test.ts, openLaneAccept.test.ts, openLaneKind.test.ts, readerOutageRefusal.test.ts, referenceAttachService.test.ts, referenceClassGate.test.ts, referenceMediumDoor.test.ts, referenceWordsLane.test.ts, refineInterpreterCeiling.test.ts, refineService.test.ts, truncatedReplyReaders.test.ts, uploadRefusalCopy.test.ts, server/db/referenceReadDemand.test.ts |
