...
| `unreadable` | interpreter-refusal |  | server/castingV2/castingIntent.ts:1252<br>server/castingV2/castingIntent.ts:1282<br>(+14) | 17 test(s) | light.softer, guard.gibberish, guard.scope.ink.none |
