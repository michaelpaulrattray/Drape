...
_Entrances:_ `server/routes/castingV2.ts`  ·  _Flags:_ `CASTING_V2_SCOPE` · `CASTING_RETRY_SCOPE` · `CASTING_ROLL_ENGINE_FLARE_SCOPE`
...
| `busy` | service-refusal |  | server/castingV2/refineService.ts:4897<br>server/castingV2/rollEngine.ts:81<br>(+1) | 2 test(s) | _documented-unreachable or gap — see findings_ |
