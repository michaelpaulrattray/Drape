...
| door | kind | charge | where it lives | pinned | reached by |
|---|---|---|---|---|---|
| `candidate_missing` | service-refusal |  | server/castingV2/refineService.ts:1210 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `already_signed` | service-refusal |  | server/castingV2/refineService.ts:1227 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `busy` | service-refusal |  | server/castingV2/refineService.ts:4897<br>server/castingV2/rollEngine.ts:94<br>(+1) | 2 test(s) | _documented-unreachable or gap — see findings_ |
| `refine_limit` | service-refusal |  | server/castingV2/refineService.ts:4318 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `master_missing` | service-refusal |  | server/castingV2/refineService.ts:1216 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `version_missing` | service-refusal |  | server/castingV2/refineService.ts:2527 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `history_unreadable` | service-refusal |  | server/castingV2/refineService.ts:3624 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `history_predates_undo` | service-refusal |  | server/castingV2/refineService.ts:2921 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `step_moved` | service-refusal |  | server/castingV2/refineService.ts:2601 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `kind_unserved` | service-refusal |  | server/castingV2/refineService.ts:2655 | 1 test(s) | _documented-unreachable or gap — see findings_ |
...
| `removal_absent` | service-refusal |  | server/castingV2/refineService.ts:3392 | 1 test(s) | ink.remove.none, skin.freckles.remove.none |
| `removal_unnamed` | service-refusal |  | server/castingV2/refineService.ts:2964 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `removal_not_in_brief` | service-refusal |  | server/castingV2/refineService.ts:3373 | 1 test(s) | acc.glasses.remove.none, acc.remove.branch.other |
| `removal_uncheckable` | service-refusal |  | server/castingV2/refineService.ts:3150<br>server/castingV2/refineService.ts:3167 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `removal_reread_unmatched` | service-refusal |  | server/castingV2/refineService.ts:3468 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `removal_unnameable` | service-refusal |  | server/castingV2/refineService.ts:4288 | 1 test(s) | _documented-unreachable or gap — see findings_ |
| `already_original` | service-refusal |  | server/castingV2/refineService.ts:2555 | 1 test(s) | guard.undo |
