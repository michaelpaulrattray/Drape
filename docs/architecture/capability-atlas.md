...
| `roll.uninterpretable` | roll-refusal |  | server/castingV2/briefCompiler.ts:1087<br>server/castingV2/briefCompiler.ts:1546<br>(+1) | 2 test(s) | _documented-unreachable or gap — see findings_ |
