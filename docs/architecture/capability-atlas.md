...
| `unreadable` | interpreter-refusal |  | server/castingV2/castingIntent.ts:1372<br>server/castingV2/castingIntent.ts:1408<br>(+14) | 22 test(s) | light.softer, guard.gibberish, guard.scope.ink.none |
...
| `concept.unreadable` | concept-refusal |  | server/castingV2/conceptDescribe.ts:1245<br>server/castingV2/conceptDescribe.ts:1282<br>(+1) | 22 test(s) | _documented-unreachable or gap — see findings_ |
