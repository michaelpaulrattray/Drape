...
| `CASTING_FRAMING_TRIM_SCOPE` | his eye on strips from his OWN flagged rolls, with the untrimmed rate and the per-sheet wall-clock beside them. Live population is one sheet: 3 of 5 untrimmed against a ~6% prior, not called at n=5 | 2026-08-25 | **FINISH** — it needs rolls, not a build |
