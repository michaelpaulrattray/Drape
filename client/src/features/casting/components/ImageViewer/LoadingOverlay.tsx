...
export function LoadingOverlay({ statusMessage }: LoadingOverlayProps) {
            ...
            <div key={i} className="flex items-center gap-2">
              <div
                style={{
                  ...
                  height: 6,
                  borderRadius: '50%',
                  background: i + 1 <= step ? '#fff' : 'rgba(255,255,255,0.15)',
                  boxShadow: i + 1 === step ? '0 0 8px rgba(255,255,255,0.4)' : 'none',
              ...
              {i < totalSteps - 1 && (
                <div
                  style={{
                    width: 24,
                    height: 1,
                    background: i + 1 < step ? 'rgba(255,255,255,0.4)' : 'rgba(255,255,255,0.08)',
