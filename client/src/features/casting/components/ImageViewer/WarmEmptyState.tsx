      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: '#52525B', marginTop: 16 }}>
        ...
        <div className="flex items-center gap-4 mt-6" style={{ color: '#A1A1AA', fontSize: 10, fontWeight: 500, opacity: 0.5, pointerEvents: 'none', userSelect: 'none' }}>
