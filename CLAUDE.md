...
| `CASTING_TWO_PATHS_SCOPE` | the Wardrobe / Basics path choice — RETIRED by his ruling, and since #203 slice 1 the flag governs NOTHING: the entrance is closed and unsetting the variable is a no-op |
